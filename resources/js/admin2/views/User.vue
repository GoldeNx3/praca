<template>
    <v-container>
        ...
        <ValidationObserver ref="obs">
            <v-card class="px-4">
                <v-card-title primary-title><h4>Dane osobowe</h4></v-card-title>
                <v-card-text>
        ...
        <ValidationObserver ref="obs2">
            ...
            <v-card class="px-4">
                <v-card-title primary-title><h4>Hasło</h4></v-card-title>
                <v-card-text>
                ...
                this.$refs.obs.validate().then(valid => {
                    if (valid) {
                        ...
                        AuthService.updateUser(payload)
                                ...
                                .then(() => (this.$toastr.s("Dane osobowe zostały zaktualizowane")))
                                .catch((error) => (this.$toastr.e("Błąd aktualizacji danych osobowych")));
                    } else {
                ...
                this.$refs.obs2.validate().then(valid => {
                    if (valid) {
                        ...
                        AuthService.updatePassword(payload)
                                .then(() => (this.$toastr.s("Hasło zostało zaktualizowane")))
                                .catch((error) => (this.$toastr.e("Błąd aktualizacji hasła")));
                    } else {
                        this.toastr.e("Błędne dane formularza");
                    }
                    ;
